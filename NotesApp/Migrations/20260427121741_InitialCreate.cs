...
namespace NotesApp.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Notes",
                columns: new[] { "Id", "CategoryId", "Content", "CreatedAt", "IsArchived", "IsPinned", "Priority", "Title", "UpdateAt" },
                values: new object[,]
                {
                    { 1, 2, "Пройти лабораторную работы 27-36", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), false, true, 5, "Изуть ASP.NET Core", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc) },
