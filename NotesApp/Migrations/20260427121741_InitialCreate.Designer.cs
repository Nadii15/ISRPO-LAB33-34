...
namespace NotesApp.Migrations
{
    ...
    [Migration("20260427121741_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotesApp.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("NotesApp.Models.Note", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdateAt = new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            UpdateAt = new DateTime(2026, 1, 2, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 3,
                            ...
                            UpdateAt = new DateTime(2026, 1, 3, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 4,
                            ...
                            UpdateAt = new DateTime(2026, 1, 4, 0, 0, 0, 0, DateTimeKind.Utc)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            UpdateAt = new DateTime(2026, 1, 5, 0, 0, 0, 0, DateTimeKind.Utc)
                        });
                });

            modelBuilder.Entity("NotesApp.Models.Note", b =>
                {
                    b.HasOne("NotesApp.Model.Category", "Category")
                        .WithMany("Notes")
