...
public class AppDbContext : DbContext {
    ...
    new Category {
     ...
     modelBuilder.Entity<Note>().HasData(
        new Note{
        Id = 1,
        Title = "Изуть ASP.NET Core",
        Content = "Пройти лабораторную работы 27-36",
        Priority = 5,
        IsPinned = true,
        IsArchived = false,
        CategoryId = 2,
        CreatedAt = new DateTime(2026,1,1,0,0,0, DateTimeKind.Utc),
        UpdateAt = new DateTime(2026,1,1,0,0,0, DateTimeKind.Utc)
        },
        new Note {
        Id = 2,
    ...
    new Note {
        ...
        UpdateAt = new DateTime(2026, 1, 3, 0, 0, 0, DateTimeKind.Utc)
    },
    new Note {
        Id = 4,
        ...
        UpdateAt = new DateTime(2026, 1, 4, 0, 0, 0, DateTimeKind.Utc)
    },
    new Note {
        Id = 5,
        ...
        UpdateAt = new DateTime(2026, 1, 5, 0, 0, 0, DateTimeKind.Utc)
    }
     );
